...
def bwa_wgs(fq1, fq2, out_dir):
    ...
    cmd1 = "{} mem -t {} {} {} {} | {} view -bS - > {}".format(bins.bwa, bins.threads, bins.ref, fq1, fq2,bins.samtools, out_bam)
...
def seeksv(out_dir, fq1, fq2):
    ...
    cmd2 = "{} mem {} {}.clip.fq.gz | {} view -Sb -o {}.clip.bam -".format(bins.bwa, bins.ref, out_prefix, bins.samtools, out_prefix)
    '''
