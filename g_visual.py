...
def parse_balance_lh(balanced_lh,out_seg):
    ...
    for line in b_in.readlines():
        if "SEG " in line:
            ...
            line = line.split(" ")
            a = line[1].split(":")
            out_fin.write("{}\t{}\t{}\t{}\t{}\t{}\n".format(a[2],a[3],a[4],a[1],line[3],line[-1]))
...
if __name__ == "__main__":
    parse_hap("/home/caronkey/Documents/cityu/hpv/localHapHpv/demo_files/simulate/AB014381.1_chr21/test.traversed",'/home/caronkey/Documents/cityu/hpv/localHapHpv/demo_files/simulate/AB014381.1_chr21/t3.balanced.lh','.')